...
echo "Installing Aman Freelance configuration..."
...
cp "$REPO_DIR/skills/freelance-skill.md" ~/.askill/skills.md
echo "  Skills: ~/.askill/skills.md"

echo ""
echo "=== Setup Complete ==="
echo ""
echo "To start Aman Freelance:"
