...
echo "Installing Aman Kedai configuration..."
...
cp "$REPO_DIR/skills/kedai-skill.md" ~/.askill/skills.md
echo "  Skills: ~/.askill/skills.md"

echo ""
echo "=== Setup Complete ==="
echo ""
echo "To start Aman Kedai:"
...
echo "  4. Tell your bot your menu items, then start logging orders!"
echo ""
