...
# Backup existing ecosystem files
...
# Copy Aman Bahasa config files
echo "Installing Aman Bahasa configuration..."
...
cp "$REPO_DIR/skills/bahasa-skill.md" ~/.askill/skills.md
echo "  Skills: ~/.askill/skills.md"

echo ""
echo "=== Setup Complete ==="
echo ""
echo "To start Aman Bahasa:"
