...
echo "Installing Aman Team configuration..."
...
cp "$REPO_DIR/skills/team-skill.md" ~/.askill/skills.md
echo "  Skills: ~/.askill/skills.md"

echo ""
echo "=== Setup Complete ==="
echo ""
echo "To start Aman Team:"
echo "  1. Make sure .env has your TELEGRAM_BOT_TOKEN and LLM API key"
echo "  2. Create a Telegram group and add your team"
echo "  3. Add the bot to the group (see content/guides/setup-guide.md)"
echo "  4. Run: npx @aman_asmuei/achannel serve"
echo ""
