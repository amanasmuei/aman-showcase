...
echo "Installing Aman Rutin configuration..."
...
cp "$REPO_DIR/skills/rutin-skill.md" ~/.askill/skills.md
echo "  Skills: ~/.askill/skills.md"

echo ""
echo "=== Setup Complete ==="
echo ""
echo "To start Aman Rutin:"
...
echo "  4. Tell the bot your medications and daily routines!"
echo ""
