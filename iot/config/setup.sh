...
echo "Installing Aman IoT configuration..."
...
cp "$REPO_DIR/skills/iot-skill.md" ~/.askill/skills.md
echo "  Skills: ~/.askill/skills.md"

echo ""
echo "=== Setup Complete ==="
echo ""
echo "To start Aman IoT:"
...
echo ""
echo "To connect your IoT device:"
echo "  - See content/guides/getting-started.md for ESP32 and Raspberry Pi examples"
echo "  - Send sensor data to the bot in format: sensor:my-sensor-01 temp:28.5 humidity:75"
echo ""
